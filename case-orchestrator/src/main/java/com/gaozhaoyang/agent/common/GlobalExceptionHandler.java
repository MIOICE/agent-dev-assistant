...
import com.gaozhaoyang.agent.casework.CaseNotFoundException;
import com.gaozhaoyang.agent.casework.InvalidCaseStateException;
...
public class GlobalExceptionHandler {
    ...
    public ApiError handleCaseNotFound(CaseNotFoundException exception) {
        return new ApiError("CASE_NOT_FOUND", exception.getMessage(), Instant.now());
    }

    @ExceptionHandler(InvalidCaseStateException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ApiError handleInvalidCaseState(InvalidCaseStateException exception) {
        return new ApiError("INVALID_CASE_STATE", exception.getMessage(), Instant.now());
    }
